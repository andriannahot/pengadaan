                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                        <a href="{{asset(Storage::url($p['laporan']))}}" class="btn btn-warning" target="_blank"><i class="fas fa-eye">Lihat Laporan</i></a>
                        @endif
                        @endif
                      ...
                      <td><a href="{{asset(Storage::url($p['laporan']))}}" class="btn btn-warning" target="_blank"><i class="fas fa-eye">Lihat Laporan</i></a></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
...
<script type="text/javascript">
  ...
  $(document).on("click", ".konfirmasi", function(event){
    ...
    var answer = window.confirm("Kamu Ingin Memproses Data...??");
