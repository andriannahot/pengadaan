                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                        <a href="/nonAktif/{{$sup->id_suplier}}" class="btn btn-danger konfirmasi"><i class="fa fa-times"> Non Aktif</i></a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
...
<script>
  ...
  $(document).on("click", ".konfirmasi", function(event){
    ...
    var answer = window.confirm("Kamu Yakin Memproses  Data Ini...??");
