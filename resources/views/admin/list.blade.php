                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button data-toggle="modal" data-target="#ubahModal" type="button" class="btn btn-secondary ubah"
                        data-id_admin="{{$adm->id_admin}}"
                        data-nama="{{$adm->nama}}"
                        data-email="{{$adm->email}}"
                        data-alamat="{{$adm->alamat}}"> <i class="fas fa-edit"></i>Ubah Data</button>

                        <a class="konfirmasi" href="/hapusAdmin/{{$adm->id_admin}}"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i>Hapus Data</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
