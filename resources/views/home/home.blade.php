...
<head>
  ...
  <title>Pengadaan App - Index</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Kita Memberikan Kesempatan Kepada UMKM yang ingin mengajukan pengajuan</h2>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut Adalah Daftar Pengadaan yang Aktif.</p>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://pengadaan.com">Pengadaan</a>
      </div>
    </div>
  </footer><!-- End Footer -->
